...
export const ActivityPackages = [
  ...
  },
  {
    ...
    displayName: 'ERPNext',
    description:
      'Tự động hóa quy trình mua sắm trong ERPNext (Mặt hàng, MR, RFQ, PO)',
    library: 'RPA.ERPNext',
    activityTemplates: [
      {
      ...
      },
      {
        ...
        description:
          'Kiểm tra nếu mặt hàng tồn tại trong ERPNext; nếu không, tự động tạo mới.',
        iconCode: 'FaBox',
        type: 'activity',
      ...
      // Assignment Management
      {
        ...
        description:
          'Tạo tài liệu Yêu cầu vật tư trong ERPNext với nhiều mặt hàng.',
      ...
      },
      {
        ...
        description:
          'Tạo một RFQ trong ERPNext cho một hoặc nhiều nhà cung cấp.',
      ...
      },
      {
        ...
        description:
          'Tạo tài liệu Đơn hàng mua trong ERPNext cho một nhà cung cấp.',
        ...
        arguments: {
          ...
          Items: {
            type: 'list',
            description:
              'Danh sách mặt hàng cần đặt (với item_code, qty, rate)',
            keywordArg: 'items',
            value: [],
          },
          'Default Rate': {
